...
final class normal_input_Tests: XCTestCase {
    ...
    func testExample2() throws {
        ...
        let input = ["ㅏ", "ㅏ", "ㄴ", "ㅏ"]
        let expectation = c.toString(from: HangeulDictionary.fixed.jungseong.ㅏ.rawValue)! + c.toString(from: HangeulDictionary.fixed.jungseong.ㅏ.rawValue)! + "나"
    ...
    func testExample3() throws {
        ...
        let c = HangeulConverter()
        let input = ["ㅏ", "ㅣ", "ㄴ", "ㅏ"]
        let expectation = c.toString(from: HangeulDictionary.fixed.jungseong.ㅐ.rawValue)! + "나"
    ...
    func testExample7() throws {
        ...
        let expectation = c.toString(from: HangeulDictionary.fixed.jungseong.ㅓ.rawValue)! + c.toString(from: HangeulDictionary.fixed.jungseong.ㅏ.rawValue)! + c.toString(from: HangeulDictionary.fixed.choseong.ㅁ.rawValue)! + "죄도시갃"
