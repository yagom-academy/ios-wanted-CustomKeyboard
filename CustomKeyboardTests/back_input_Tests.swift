...
final class back_input_Tests: XCTestCase {
    ...
    func testExample3() throws {
        ...
        let expectation = c.toString(from: HangeulUnicodeType.Fixed.jungseong.ㅓ.rawValue)
    ...
    func testExample7() throws {
        ...
        let expectation = c.toString(from: HangeulUnicodeType.Fixed.jungseong.ㅗ.rawValue)! + c.toString(from: HangeulUnicodeType.Fixed.choseong.ㄴ.rawValue)! // "ㅗㄴ"
    ...
    func testExample8() throws {
        ...
        let expectation = c.toString(from: HangeulUnicodeType.Fixed.jungseong.ㅗ.rawValue)! + c.toString(from: HangeulUnicodeType.Fixed.choseong.ㄴ.rawValue)! + "계자욉금지" // "ㅗㄴ계자욉금지"
