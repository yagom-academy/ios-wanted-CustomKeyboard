...
final class back_input_Tests: XCTestCase {
    ...
    func testExample3() throws {
        ...
        let expectation = c.toString(from: HangeulDictionary.fixed.jungseong.ㅓ.rawValue)
    ...
    func testExample7() throws {
        ...
        let expectation = c.toString(from: HangeulDictionary.fixed.jungseong.ㅗ.rawValue)! + c.toString(from: HangeulDictionary.fixed.choseong.ㄴ.rawValue)! // "ㅗㄴ"
    ...
    func testExample8() throws {
        ...
        let expectation = c.toString(from: HangeulDictionary.fixed.jungseong.ㅗ.rawValue)! + c.toString(from: HangeulDictionary.fixed.choseong.ㄴ.rawValue)! + "계자욉금지" // "ㅗㄴ계자욉금지"
